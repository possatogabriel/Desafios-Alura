...
public class Tarefa {
    ...
    public void rodaExercicio4() {
        ...
        Tarefa tarefa1 = new Tarefa("Realizar exercícios opcionais", true, "Gabriel Possato");
    ...
    public void rodaExercicio5() {
        ...
        try {
            var tarefa1 = mapper.readValue(new File("src/main/java/br/com/alura/cursos/contador/json/tarefa1.json"), Tarefa.class);
